...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>BANK OF TSF</h2></a>
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a href="viewcustomers.php" class="nav-link text-white ">OUR CUSTOMERS</a></li>
              <li class="nav-item">
     ...
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="main_text">BANK OF TSF</h1>
            <p class="big-text">One place for all transactions</p>
          </div>
          <div class="col-sm-6">
            
            <img src="images/bank.png" class="img-fluid" width="560" height="345" style="margin-top:20px;">
  ...
  <section class="contactus" id="contact" >
        <div class="container headings text-center">
            ...
            <p>For any related queries or help, kindly reach out to us. We will be glad to help you.</p>
        </div>
        <div class="container">
            <div class="row">
                        ...
                        <form action="/action_page.php">
                            ...
                            <form action="/action_page.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" id="comment" placeholder="Enter your Comments here"></textarea>
                                  </div>
